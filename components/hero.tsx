    ...
    >
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          >
            <div className="text-6xl md:text-8xl font-bold">
              ...
              <FontCycler text="I'm Aarit" onComplete={() => setFontCycleComplete(true)} />
                      ...
                      <motion.p
                        className="text-xl md:text-2xl text-muted-foreground mb-4 max-w-2xl font-medium font-[var(--font-ubuntu)]"
                        initial={{ opacity: 0, y: 30 }}
                        animate={{ opacity: 1, y: 0 }}
                      ...
                      <motion.p
                        className="text-lg text-muted-foreground mb-8 max-w-xl font-[var(--font-inter)]"
                        initial={{ opacity: 0, y: 30 }}
                        animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              ...
              <motion.a
                ...
                className="group relative p-4 rounded-full glass-card hover:border-primary/50 transition-all"
          ...
          >
            <span className="text-sm font-medium font-[var(--font-ubuntu)]">Scroll to explore</span>
            <motion.div
              animate={{ y: [0, 8, 0] }}
